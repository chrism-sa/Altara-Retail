...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark sticky-top">
    <div class="container">
      <a class="navbar-brand px-3 bg-warning" href="https://www.instagram.com/altaaraaa">
        <?php echo $toko ?>
      </a>
      <button class="navbar-toggler border-0" type="button" data-toggle="collapse" data-target="#navbarC"
      ...
      <div class="collapse navbar-collapse" id="navbarC">
        <ul class="navbar-nav ml-auto">
          ...
          <?php
              $lev = $_SESSION['username'] == 'admin';
              $leve = $_SESSION['username'] == 'kasir';
              if ($lev && !$leve) {
                ?>
            <li class="nav-item">
