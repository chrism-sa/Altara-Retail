...
<?php
$queryuse = mysqli_query($conn, "SELECT * FROM login");
$caruser = mysqli_fetch_assoc($queryuse);
            ...
            <div class="row">
                ...
                <div class="col-8 pl-0">
                    <?php if($_SESSION['username']=='admin'){ ?>
                        <input type="text" class="form-control form-control-sm bg-white" value="<?php echo 'Admin' ?>" >
                    <?php } else{ ?>
                        <input type="text" class="form-control form-control-sm bg-white" value="<?php echo 'Kasir' ?>" >
                   <?php } ?>
                </div>
            </div>
        </div>
...
<div class="d-none pt-5 px-4 print-show">
    <div class="row">
        ...
        <div class="col-12 text-center">
            ...
            <p class="h4 text-muted">Copyright &copy;
        <?php echo date("Y"); ?>
        <b>ALTARA</b></a>. All Rights Reserved
    </p>
        </div>
    </div><!-- end row -->
</div><!-- end box print -->
